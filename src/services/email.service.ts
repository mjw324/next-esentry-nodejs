...
export class EmailService {
  ...
  async sendVerificationEmail(
    ...
    await this.transporter.sendMail({
      ...
      to,
      subject: `Confirmation Code for eSentry: ${verificationPin}`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
  ...
  async sendNewItemsNotification(
    ...
    await this.transporter.sendMail({
      from: emailConfig.from,
      to,
      subject: `eSentry - New items found for "${monitorTitle}"`,
      html: `
  ...
  async sendAccountVerificationEmail(
    ...
    await this.transporter.sendMail({
      from: emailConfig.from,
      to,
      subject: 'Verify Your eSentry Account',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
  ...
  async sendPasswordResetEmail(
    ...
    await this.transporter.sendMail({
      from: emailConfig.from,
      to,
      subject: 'Reset Your eSentry Password',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
